...
public:
 ...
 //    	for (int it = -x; it <= x; ++it)
	...
	void drawView(View V, int r, int g, int b, int t) {
		...
		drawLine(V.P1,Point(V.P2.x,V.P1.y),255,255,255,0);
		drawLine(Point(V.P2.x,V.P1.y),V.P2,255,255,255,0);
		drawLine(V.P2,Point(V.P1.x,V.P2.y),255,255,255,0);
		drawLine(Point(V.P1.x,V.P2.y),V.P1,255,255,255,0);
	}
	...
	// keterbatasan: cuman bisa gambar vector of polygon aja, ga ada yang saling nimpa atau membentuk cycle
	// ideal: rgbt itu properties dari polygon
